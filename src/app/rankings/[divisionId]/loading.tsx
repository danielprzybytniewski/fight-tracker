export default function RankingsDivisionLoading() {
  return (
    <div
      className="container rounded-lg mx-auto p-4 py-8 dark:bg-gray-900"
    ...
    >
      ...
      <div className="mb-8 animate-pulse">
        <div className="h-64 sm:h-72 mb-4 rounded-lg bg-gray-300 dark:bg-gray-700" />
        <div className="h-8 mb-2 rounded bg-gray-300 dark:bg-gray-700" />
        <div className="h-6 mb-1 rounded bg-gray-300 dark:bg-gray-700" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
        {Array.from({ length: 6 }).map((_, index) => (
          <div key={index} className="animate-pulse">
            <div className="h-48 sm:h-56 mb-2 rounded-lg bg-gray-300 dark:bg-gray-700" />
            <div className="h-6 mb-2 rounded bg-gray-300 dark:bg-gray-700" />
            <div className="h-4 mb-1 rounded bg-gray-300 dark:bg-gray-700" />
          </div>
        ))}
      </div>
    </div>
